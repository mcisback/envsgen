...
myproject/
├── configs/
│   ├── master.toml       # Main entry point (imports everything)
│   ├── shared.toml       # Shared secrets & variables
│   ├── apps.toml         # PHP application config
│   ├── docker.toml       # Docker Compose configuration
│   └── caddy.toml        # Caddyfile configuration
├── caddy/
│   └── Caddyfile         # Generated by envsgen
├── docker/
│   └── docker-compose.yml # Generated by envsgen
├── apps/
│   └── myphpapp.com/
│       ├── .env.local     # Generated by envsgen
│       ├── .env.prod      # Generated by envsgen
│       └── src/
│           └── index.php
├── generate.sh           # Script to generate all configs
└── README.md
```
...
## 🚀 Step 3: Generate Your Configurations
